...
// so I guess what we want is a script which calculates the number of pages that need to appear in the pagination div, courtesy of bootstrap, and renders that

// we also want a script that renders the right number of cards onto the page
